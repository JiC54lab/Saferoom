        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("⚜️About Safe Room⚜️", callback_data="aboutbot")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Team](https://t.me/JiC54supportbot)",
                                     disable_web_page_preview=True)
            return
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                [
                InlineKeyboardButton("Save in Batch", callback_data="addToBatchTrue"), InlineKeyboardButton("Get Link", callback_data="addToBatchFalse")
                ]
            ]),
            quote=True,
            disable_web_page_preview=True
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=JiC54_{str_to_b64(file_er_id)}"
    ...
    if "aboutbot" in cb_data:
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("😌Source Code of Safe Room😌",
                                             url="https://t.me/JiC54_SERIES_Bot")
                    ],
                    [
                        InlineKeyboardButton("🏠Home🏠", callback_data="gotohome"),
                        InlineKeyboardButton("📣JiC54 Channels📣", callback_data="aboutdevs")
                    ]
                ]
            )
        )
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("⚜️About Bot⚜️", callback_data="aboutbot"),
                        InlineKeyboardButton("🏠Home🏠", callback_data="gotohome")
                    ]
                ]
            )
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Team](https://t.me/JiC54supportbot).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="**You Still Didn't Join ☹️, You can't use Safe Room unless you join My Updates Channel!**\n\n"
                         "⚠️Due to Overload, Only Channel Subscribers can use Safe Room!",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact [Support Team](https://t.me/JiC54supportbot).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
                               ...
                               reply_markup=InlineKeyboardMarkup(
                                [
                                   [InlineKeyboardButton("Get Batch Link", callback_data="getBatchLink"),
                                    InlineKeyboardButton("Terminate❌", callback_data="closeMessage")
                                    ]
                               ]))
        ...
        if message_ids is None:
            ...
            return
        jic = await cmd.message.edit("Please wait, generating batch link")
        jic1 = await jic.edit("Please wait, generating batch link.")
        jic2 = await jic1.edit("Please wait, generating batch link..")
        await jic2.edit("Please wait, generating batch link...")
